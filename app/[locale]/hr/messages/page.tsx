...
export default function MessagesPage() {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    const newMsg = {
      ...
      sender: "hr",
      content: newMessage,
      timestamp: t('hr.messages.justNow'),
    }
    ...
    <div className="flex flex-col min-h-screen" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="flex-1 bg-gray-50">
        <div className="container h-full px-4 py-6 mx-auto">
          <div className="mb-6">
            <h1 className="text-3xl font-bold">{t('hr.messages.title')}</h1>
            <p className="text-gray-500">{t('hr.messages.subtitle')}</p>
          </div>
            ...
            <div className="border-r">
              <div className="p-4 border-b">
                <div className="relative">
                  ...
                  <Input
                    placeholder={t('hr.messages.searchPlaceholder')}
            ...
            <div className="flex flex-col md:col-span-2">
              <div className="flex items-center gap-4 p-4 border-b">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">{t('hr.messages.applicantRole')}</p>
                </div>
              </div>
              <div className="flex-1 p-4 overflow-auto">
                <div className="space-y-4">
                  {messages.map((message) => (
                    <div
                      key={message.id}
                      className={`flex ${message.sender === "hr" ? (locale === 'ar' ? 'justify-start' : 'justify-end') : (locale === 'ar' ? 'justify-end' : 'justify-start')}`}
                    >
                      <div
              ...
              <div className="p-4 border-t">
                <form onSubmit={handleSendMessage} className="flex gap-2">
                  <Input
                    placeholder={t('hr.messages.messagePlaceholder')}
                    value={newMessage}
