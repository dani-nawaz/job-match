...
const mockStudents = [
  ...
  },
  {
    ...
    careerGoals:
      "I aim to specialize in frontend development with a focus on creating beautiful, accessible interfaces.",
    gpa: "3.6",
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-500">
                Viewing candidates for <span className="font-medium">{job.title}</span>
              </p>
            </div>
            ...
            <div className="space-y-4 md:col-span-3">
              <div className="flex items-center justify-between">
                ...
                <p className="text-sm text-gray-500">
                  Showing {filteredStudents.length} of {mockStudents.length} candidates
                </p>
                */}
              ...
              <Tabs defaultValue="all">
                <TabsList className="mb-4">
                  ...
                  <TabsTrigger value="high-match">High Matches</TabsTrigger>
                </TabsList>
                <TabsContent value="all" className="space-y-4">
                  {filteredStudents.length > 0 ? (
                    filteredStudents.map((student) => <ApplicantCard key={student.id} student={student} job={job} />)
                  ) : (
                    <Card className="p-8 text-center">
                      <User className="w-12 h-12 mx-auto text-gray-300" />
                      <h3 className="mt-4 text-xl font-semibold">No candidates found</h3>
                      <p className="mt-2 text-gray-500">Try adjusting your filters to find more candidates.</p>
                      <Button
                        variant="outline"
                        className="mt-4"
                        onClick={() => {
                ...
                <TabsContent value="high-match" className="space-y-4">
                  {filteredStudents.filter((student) => student.match >= 80).length > 0 ? (
                    filteredStudents
                      ...
                      .map((student) => <ApplicantCard key={student.id} student={student} job={job} />)
                  ) : (
                    <Card className="p-8 text-center">
                      <User className="w-12 h-12 mx-auto text-gray-300" />
                      <h3 className="mt-4 text-xl font-semibold">No high match candidates found</h3>
                      <p className="mt-2 text-gray-500">Try adjusting your filters to find more candidates.</p>
                    </Card>
                  )}
                </TabsContent>
...
function ApplicantCard({ student, job }: { student: (typeof mockStudents)[0]; job: (typeof mockJobs)[0] }) {
    ...
    <Card className="overflow-hidden">
      <CardContent className="p-0">
        <div className="p-6">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            <p className="text-sm font-medium w-full">Matching Job Skills</p>
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            <p className="text-sm font-medium w-full">Skills</p>
          ...
          {expanded && (
            <div className="mt-4 space-y-4">
              ...
              <div>
                <p className="text-sm font-medium">Dream Companies</p>
                <div className="flex flex-wrap gap-2 mt-1">
              ...
              <div>
                <p className="text-sm font-medium">Previous Internships</p>
